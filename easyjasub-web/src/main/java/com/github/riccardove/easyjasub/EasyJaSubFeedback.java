...
class EasyJaSubFeedback implements EasyJaSubObserver {
	private final PrintWriter outputStream;
	private final PrintWriter errorStream;
	private final int verbose;

	public EasyJaSubFeedback(PrintWriter outputStream, PrintWriter errorStream,
			int verbose) {
	...
	public void onReadTranslatedSubtitlesStart(File file) {
		lowVerboseMessage("onReadTranslatedSubtitlesStart "
				+ toString(file));
	}
	...
	@Override
	public void onWriteImagesEnd(String wkhtml, File htmlFolder,
			File bdnFolder) {
	...
	public void onWriteOutputJapaneseTextFileEnd(File file) {
		lowVerboseMessage("onWriteOutputJapaneseTextFileEnd "
				+ toString(file));
	}
	...
	public void onReadJapaneseSubtitlesIOError(File file, IOException ex)
		...
		throw new EasyJaSubException(
				"Error reading japanese subtitles file " + toString(file)
	...
	public void onReadJapaneseSubtitlesParseError(File file,
		...
		throw new EasyJaSubException(
				"Error parsing japanese subtitles file " + toString(file)
	...
	public void onReadTranslatedSubtitlesIOError(File file, IOException ex)
			throws EasyJaSubException {
		throw new EasyJaSubException(
				"Error reading translated subtitles file " + toString(file)
						+ ": " + ex.getLocalizedMessage());
	}
	...
	public void onReadTranslatedSubtitlesParseError(File file,
			InputTextSubException ex) throws EasyJaSubException {
		throw new EasyJaSubException(
				"Error parsing translated subtitles file " + toString(file)
						+ " content: " + ex.getLocalizedMessage());
	}
	...
	public void onWriteCssIOError(File file, IOException ex)
			throws EasyJaSubException {
		throw new EasyJaSubException("Error writing css file "
	...
	public void onReadTranslatedSubtitlesSkipped(File file) {
		lowVerboseMessage("onReadTranslatedSubtitlesSkipped "
				+ toString(file));
	}
	...
	public void onReadJapaneseSubtitlesSkipped(File file) {
		lowVerboseMessage("onReadJapaneseSubtitlesSkipped "
				+ toString(file));
	}
	...
	public void onWriteXmlFileIOError(File file, IOException ex)
			throws EasyJaSubException {
		throw new EasyJaSubException("Error writing XML file "
				+ toString(file) + ": " + ex.getLocalizedMessage());
	}
	...
	@Override
	public void onConvertToHtmlSubtitleListError(File htmlFolder,
			IOException ex) throws EasyJaSubException {
	...
	public void onDictionaryDeserializeError(File file, Exception ex) {
		lowVerboseMessage("Error deserializing dictionary "
				+ toString(file) + ": " + ex.getLocalizedMessage());
	}
